...
public class Course {
    ...
    public static void insertCourse(Course course) {
        ...
        String sql = "INSERT INTO courses (id,name,content,teacher_id,status) VALUES (?,?,?,?,?)";
    ...
    public static List<Course> getAllCourses() {
        ...
        try (PreparedStatement statement = con.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                Course course = new Course(rs.getInt("id"), rs.getString("name"), rs.getString("content"), rs.getBoolean("status"),rs.getInt("teacher_id"));
